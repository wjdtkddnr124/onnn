...
public class Mainclass02 {
	public static void main(String[] args) {
		...
		// int type형 변수 선언과 동시에 값 대입하기
		int num1=10;
		// int type 변수 선언만 하고 ( 지역변수는 선언만하면 만들어 지지 않는다 )
		int num2;
		 ...
		 */
		byte c=(byte)myInt; // 강제 casting 을 대입 가능
		// 100이 저장되어 있는 변수에 200 을 대입하고
		myInt=200;
